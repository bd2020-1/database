CREATE TABLE tb_QuestionGroupFormRecord (
  ...
  answer                    varchar(512), 
  PRIMARY KEY (questionGroupFormRecordID)) comment='(pt-br) Tabela para registro da resposta associada a uma questão de um agrupamento de um formulário referente a um questionario de avaliação.(en) Form record table.' engine=InnoDB;
...
(en) Table for patient records.' engine=InnoDB;
...
(en) Table for hospital units identification.' engine=InnoDB;
...
(en) description.', 
  PRIMARY KEY (listTypeID)) engine=InnoDB;
CREATE TABLE tb_QuestionType (
  questionTypeID int(10) NOT NULL AUTO_INCREMENT, 
  description    varchar(255) NOT NULL comment '(pt-br) Descrição.
(en) description.', 
  CONSTRAINT questionTypeID 
    PRIMARY KEY (questionTypeID)) engine=InnoDB;
CREATE TABLE tb_QuestionGroup (
  questionGroupID int(10) NOT NULL AUTO_INCREMENT, 
  description     varchar(255) NOT NULL comment '(pt-br) Descrição.
(en) description.', 
  comment         varchar(255), 
  PRIMARY KEY (questionGroupID)) comment='Relacionado ao Question Group da ontologia relaciona as diversas sessoes existentes nos formularios do CRF COVID-19' engine=InnoDB;
...
(en) Represents all standard values on the form.' engine=InnoDB;
...
Desfecho - Modulo 3
(en)
tb_CRFForms identifies the type of the form refers to the Questionnaire Subsection of Ontology: Admission - Module 1 Monitoring - Module 2 Outcome - Module 3' engine=InnoDB;
...
CREATE TABLE tb_FormRecord (
  ...
  PRIMARY KEY (formRecordID)) engine=InnoDB;
...
CREATE TABLE tb_TermType (
  ...
  PRIMARY KEY (termTypeID)) engine=InnoDB;
...
CREATE TABLE tb_GroupRole (
  ...
  description varchar(255) NOT NULL, 
  PRIMARY KEY (groupRoleID)) engine=InnoDB;
...
CREATE TABLE tb_Permission (
  ...
  description  varchar(255) NOT NULL, 
  PRIMARY KEY (permissionID)) engine=InnoDB;
CREATE TABLE tb_GroupRolePermission (
  groupRoleID  int(11) NOT NULL, 
  permissionID int(11) NOT NULL, 
  PRIMARY KEY (groupRoleID, 
  permissionID)) engine=InnoDB;
